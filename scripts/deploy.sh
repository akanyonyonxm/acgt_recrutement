...
# Docker + plugin Compose installés. Le certificat TLS s'amorce séparément avec
# scripts/init-letsencrypt.sh (voir DEPLOIEMENT.md).
set -euo pipefail
...
echo "### 4/5 Application (build + redémarrage)..."
...
echo "### Déploiement terminé : https://recrutement.acgt.cd"
